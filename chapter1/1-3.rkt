...
(define (n-root n x damp-n)
  (fixed-point ((repeated average-damp damp-n) (lambda (y) (/ x (expt y (- n 1)))))
               1.0))
...
;; 지수가 3을 넘으면 average-damp를 3번 적용하면 잘 작동됬다.

;; exercise 1.46

(define (iterative-improve enough? improve first-guess)
  (define (try guess)
